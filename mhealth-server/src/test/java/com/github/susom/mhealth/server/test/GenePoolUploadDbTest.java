...
public class GenePoolUploadDbTest {
  private Vertx vertx;
  ...
  public void setUp(TestContext context) throws Exception {
    ...
    dbb.transact(dbp -> {
      ...
      MhealthDao mhealth = new MhealthDao(dbp, 200L);
      //signUp and signIn first user "123"
      String deviceRpid = myPart.registerDevice("123", "me2@gmail.com", "896", "MyHeart Counts iOS App",400L);
      Long userRpId1 = myPart.verifyEmail("me2@gmail.com",400L,deviceRpid,111L);
      Long deviceAppId1 = mhealth.createDeviceApp(200L,"$2a$16$ZChp8/nCBmf5BB/HXL2jmehjGJmXjcdGyI5Wn.8wjL.4zvKMMXb.e","password_bcryted",deviceRpid);
      Long mhUserProfId1 = mhealth.createMhUserProfile(userRpId1);
      mhealth.updateMhDeviceApp(deviceRpid, mhUserProfId1);
      myPart.createBaseConsent(400L,deviceRpid,"me2@gmail.com",new GregorianCalendar(2014, Calendar.FEBRUARY, 11).getTime(),"sponsors_and_partners",null,null,0L);
    });
  }
