...
public class MyHeartCountsAPITwentyThreeAndMeMockDbTest {
  private Vertx vertx;
  private MyHeartCountsApi myApi;
  ...
  public void setUp(TestContext context) throws Exception {
    ...
    TwentyThreeAndMeApi myApi1 = new TwentyThreeAndMeApi(dbb, random, config, twentyThreeAndMe);
    myApi = new MyHeartCountsApi(dbb, random, jwt, config, vertx, myApi1);
  ...
  public void test23andmeUserAndRefreshTokenFailure(TestContext context) {
    ...
    vertx.getOrCreateContext().runOnContext(v ->
        myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler -> {
          ...
          if (resultHandler.succeeded()) {
            myApi.twentyThreeAndMe.findTheDownloadStatus("statusKey1", routingContext, resultHandler2 -> {
  ...
  public void test23andmeSuccessScenario(TestContext context) {
    ...
    TwentyThreeAndMeApi spy = spy(myApi.twentyThreeAndMe);
    when(routingContext.response()).thenReturn(response);
  ...
  public void test23andmeUserInfoReturning308Code(TestContext context) {
    ...
    myApi.twentyThreeAndMe.callTwentyThreeAndMe("userId3", "bToken3", "profileId3", "rToken3", routingContext,
        resultHandler -> {
  ...
  public void test23andmeWhenUserInfoReturns401(TestContext context) {
    ...
    myApi.twentyThreeAndMe.callTwentyThreeAndMe("userId4", "bToken4", "profileId4", "rToken4", routingContext,
        resultHandler -> {
...
//set up the database
    ...
    vertx.getOrCreateContext().runOnContext(v ->
        myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler -> {
          ...
          if (resultHandler.succeeded()) {
            myApi.twentyThreeAndMe.findTheDownloadStatus("statusKey6", routingContext, resultHandler2 -> {
              if (resultHandler2.succeeded()) {
                verify(response).setStatusCode(eq(200));
                ArgumentCaptor<String> argument = ArgumentCaptor.forClass(String.class);
                verify(response).setStatusMessage(argument.capture());
...
//set up the database
    ...
    doNothing().when(twentyThreeAndMe).geneticData(eq("profileId8"), eq("bToken8"),
        argThat(new Callback<Handler<AsyncResult<GenomeData>>>((h -> h.handle(Future.failedFuture("{\"statusCode\":"
          ...
          myApi.twentyThreeAndMe.findTheDownloadStatus("statusKey8", routingContext, resultHandler2 -> {
            if (resultHandler2.succeeded()) {
              async.complete();
            }
          });
    ...
    doNothing().when(twentyThreeAndMe).geneticData(eq("profileId9"), eq("bToken9"),
        argThat(new Callback<Handler<AsyncResult<GenomeData>>>(h -> {
          ...
          myApi.twentyThreeAndMe.findTheDownloadStatus("statusKey9", routingContext, resultHandler2 -> {
    ...
    vertx.getOrCreateContext().runOnContext(v ->
        myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler -> {
          ...
          if (resultHandler.succeeded()) {
            ...
            myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler1 -> {
              ...
              if (resultHandler1.succeeded()) {
                ...
                myApi.twentyThreeAndMe.findTheDownloadStatus("statusKey10", routingContext, result1 -> {
  ...
  public void test23andmeWhenUserInfoReturns404(TestContext context) {
    ...
    myApi.twentyThreeAndMe.callTwentyThreeAndMe("userId11", "bToken11", "profileId11", "rToken11", routingContext,
        resultHandler -> {
  ...
  public void test23andmeTestDownloadHandleWhenRrefreshTokenGives404(TestContext context) {
    ...
    vertx.getOrCreateContext().runOnContext(v ->
        myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler -> {
          ...
          if (resultHandler.succeeded()) {
            myApi.twentyThreeAndMe.findTheDownloadStatus("statusKey12", routingContext, result1 -> {
              if (result1.succeeded()) {
                verify(response).setStatusCode(eq(200));
                ArgumentCaptor<String> argument = ArgumentCaptor.forClass(String.class);
                verify(response).setStatusMessage(argument.capture());
...
//set up the database
    ...
    vertx.getOrCreateContext().runOnContext(v ->
        myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler -> {
          ...
          if (resultHandler.succeeded()) {
            myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler2 -> {
              if (resultHandler2.succeeded()) {
                myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler3 -> {
                  verifyNoMoreInteractions(twentyThreeAndMe);
  ...
  public void test23andmeWhenUserIdIsIncorrect(TestContext context) {
    ...
    myApi.twentyThreeAndMe.callTwentyThreeAndMe("userId13", "bToken14", "profileId14", "rToken14", routingContext,
        resultHandler -> {
  ...
  public void testDownloadStatusWhenNotGenotyoed(TestContext context) {
    ...
    vertx.getOrCreateContext().runOnContext(v ->
        myApi.twentyThreeAndMe.twentyThreeAndMeDownloadHandler(resultHandler -> {
          ...
          myApi.twentyThreeAndMe.findTheDownloadStatus("statusKey15", routingContext, resultHandler2 -> {
